...
export default function PlanPage() {
  ...
  return (
    <div className="plan-page">
      ...
      <StatsBar plan={plan} statFilter={statFilter} onSelectStat={setStatFilter} />
